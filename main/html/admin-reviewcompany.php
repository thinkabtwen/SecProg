...
$sql = "SELECT id, name, email, role FROM users WHERE role='Company'";
...
<html lang="en">
<head>
  <title>Review Company | Cyber Resource</title>
  <meta charset="utf-8">
  ...
  <div class="row content">
    <div class="col-sm-3 sidenav">
      ...
      <ul class="nav nav-pills nav-stacked">
        ...
        <li class="active"><a href="./admin-reviewusers.php">Review Company</a></li>
    ...
    <div class="col-sm-9">
      ...
      if ($result->num_rows > 0) {
          while ($row = $result->fetch_assoc()) {
              ...
              echo '<input type="hidden" name="company_id" value="' . htmlspecialchars($row["id"], ENT_QUOTES, 'UTF-8') . '">';
