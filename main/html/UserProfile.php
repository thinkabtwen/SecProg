...
<body>
    ...
    <div class="row col-8 border rounded mx-auto mt-5 p-2 shadow-lg">
        <div class="col-md-4 text-center mt-5">
            ...
            <div>
                <a href="./UserProfileEdit.html"><button class="mx-auto m-1 btn-lg btn btn-primary">Update Profile</button></a>
            </div>
        </div>
        <div class="col-md-8">
            ...
            <table class="container-fluid table table-striped">
                ...
                <tr><th><i class="fa fa-user-circle"></i> Name</th><td>email.@email.com</td></tr>
                <tr><th><i class="fa fa-calendar"></i> Age</th><td>email.@email.com</td></tr>
                <tr><th><i class="fa fa-envelope"></i> Email</th><td>email.@email.com</td></tr>
